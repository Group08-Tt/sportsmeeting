...
var datalistidex = []
let page = 1;
let url = "http://nb.ncha.gov.cn/je/api/load?tableCode=BWG_NBLN&whereSql=AND+NB_ND+%3D+2020&orderSql=ORDER+BY+NB_SJHDCC+DESC&page="+page+"&start=0&limit=15";
